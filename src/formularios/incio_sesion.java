 ...
 * @author gamer
 */
public class incio_sesion extends javax.swing.JFrame {

    /**
     * Creates new form incio_sesion
     */
    public incio_sesion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(incio_sesion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new incio_sesion().setVisible(true);
            }
        });
    }
